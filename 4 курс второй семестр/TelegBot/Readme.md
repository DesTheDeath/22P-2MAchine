...
### Модели
*   **Текстовая Модель:** `Gemma-3-27b-abliterated.q3` — мощная модель от Google DeepMind, оптимизированная для свободного общения (abliterated).
*   **Компонент Зрения:** `mmprojl` — мультимодальный проектор, позволяющий модели "видеть" и анализировать присланные изображения (Computer Vision).
